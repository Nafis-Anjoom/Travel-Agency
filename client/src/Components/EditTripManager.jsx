...
export default function EditTripManager(){
        ...
        <>
            <div className="container">
                <form onSubmit={handleSubmit}>
                    ...
                    <div class="mb-3">
                    <span for="description" class="form-label">Area of expertise</span>
                    ...
                    <div className="mb-3">
                        <button className="btn btn-danger">Delete Trip Manager</button>
                    </div>
                </form>
            </div>
        </>
